const permissions = [
  {
    ...
    presets: null,
    fields:
      'first_name,last_name,email,password,address1,address2,country,city,postalcode,telephone,companyName,county,outbidEmailsOk',
  },
  {
  ...
  },
  {
    ...
    presets: null,
    fields:
      'first_name,last_name,email,avatar,location,description,title,auth_data,bidjs_id,id,language,tags,preferences_divider,theme,email_notifications,last_page,last_access,external_identifier,address1,address2,country,city,provider,postalcode,telephone,username,externalRef,county,companyName,outbidEmailsOk',
  },
  {
    role: null,
    collection: 'directus_users',
    ...
    permissions: null,
    validation:
      '{"_and":[{"first_name":{"_nempty":true}},{"last_name":{"_nempty":true}},{"email":{"_contains":"@"}},{"password":{"_nempty":true}}]}',
    presets: '{"role":"E8EDAA1E-EBBC-4024-83A6-A2C832AC7D84"}',
    fields:
      'first_name,last_name,email,password,address1,address2,city,country,telephone,postalcode,username,externalRef,county,companyName,outbidEmailsOk',
  },
]
